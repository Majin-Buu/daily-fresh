package cn.com.buu.dailyfreshpc.module.vo;
...
public class BaseResult {
    ...
    public static BaseResult failed(UacErrorEnum uacErrorEnum) {
        return createBaseResult(uacErrorEnum.code(), null, uacErrorEnum.msg());
    }

    public static BaseResult failed(String msg) {
        return createBaseResult(9999, null, msg);
    }
